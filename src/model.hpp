...
struct demucs_segment_buffers_4s
{
    ...
    demucs_segment_buffers_4s(int nb_channels, int segment_samples)
        : segment_samples(segment_samples),
          ...
          x_0(48, 512, 336), x_1(96, 128, 336), x_2(192, 32, 336),
          x_3(384, 8, 336), x_3_channel_upsampled(512, 8, 336),
          xt(1, nb_channels, segment_samples),
          xt_out(1, 4 * nb_channels, segment_samples),
          xt_decoded_out(1, 8, segment_samples), xt_0(1, 48, 85995),
          xt_1(1, 96, 21499), xt_2(1, 192, 5375), xt_3(1, 384, 1344),
          xt_3_channel_upsampled(1, 512, 1344), saved_0(48, 512, 336),
          saved_1(96, 128, 336), saved_2(192, 32, 336), saved_3(384, 8, 336),
          savedt_0(1, 48, 85995), savedt_1(1, 96, 21499),
          savedt_2(1, 192, 5375), savedt_3(1, 384, 1344)
    {
